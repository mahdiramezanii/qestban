...
<body>
    ...
    <section class="download">
        ...
        <div class="download-buttons">
            <a href="marketlink" class="download-button markett">دانلود مستقیم </a>
            <a href="marketlink" class="download-button market">دانلود از بازار</a>
            <a href="myketlink" class="download-button myket">دانلود از مایکت</a>
            <a href="sibapplink" class="download-button sibapp">دانلود از سیب‌اپ</a>
            <a href="anarenlink" class="download-button anarena">دانلود از اناردونی</a>
            <a href="sibchehlink" class="download-button sibcheh">دانلود از سیبچه</a>
        </div>
    </section>
